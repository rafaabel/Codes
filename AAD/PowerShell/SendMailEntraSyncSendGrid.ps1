<#
.SYNOPSIS
    Alerts when the Entra Connect Sync duration exceeds 1 hour, via SendGrid email.
...
.DESCRIPTION
    ...
    exceeds 1 hour, an HTML alert email is built and dispatched through the SendGrid API.
