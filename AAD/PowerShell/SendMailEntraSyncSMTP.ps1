<#
.SYNOPSIS
    Alerts when the Entra Connect Sync duration exceeds 1 hour, via SMTP email.
...
.DESCRIPTION
    ...
    exceeds 1 hour, an HTML alert email is built and sent using Send-MailMessage over
    SMTP.
